...
# PATCH by mvl22 to disable recursive unlinking, which could easily lead to mistakes; now works more like Unix
/*
	        $files = scandir($path);
	        if ($files) {
...
# PATCH by mvl22 to enforce better file/folder names; see: http://stackoverflow.com/a/7410598
