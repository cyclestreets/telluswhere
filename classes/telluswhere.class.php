...
class telluswhere
{
	...
	private $boundaryDownloadSource = false;
...
#!# Move this check to constructor - should not have part of site working but not all
	...
	public function mapPanel ($showLayer, $selectedIdData = array (), $markerSetInitiallyIsDraggable = false, $viewOnlyMode = false, $initialLocation = array (), $enableDrawing = false, $markerData = array (), $enableInitialCookieLocation = true)
	{
		...
		$boundaryDownloadSourceJs = ($this->boundaryDownloadSource ? "'{$this->boundaryDownloadSource}'" : 'false');
		...
		$(function() {
			var config = {
				...
				boundaryDownloadSource: {$boundaryDownloadSourceJs},
	...
	public function sessionGet ($field)
	{
	...
	public function sessionWrite ($field, $data)
	{
	...
	public function sessionDestroy ($field)
	{
		# Remove the field
